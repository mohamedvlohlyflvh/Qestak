      ...
      <section className="max-w-6xl mx-auto px-4 pt-16 sm:pt-20 pb-24 text-center">
            ...
            <div key={plan.name} className="glass-card p-4 sm:p-6 flex flex-col">
              ...
              {plan.name === "مجاني" ? (
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm font-bold font-mono text-primary" dir="ltr">01093195795</p>
                  <p className="text-sm font-bold font-mono text-primary" dir="ltr">01206363468</p>
        ...
        <div className="mt-8 glass-card !p-5 max-w-md mx-auto">
          <p className="text-sm text-muted-foreground">
            للاشتراك، تواصل على أحد الرقمين <strong>أولاً</strong>، ثم قم بالتحويل على رقم فودافون كاش بعد التنسيق.
          </p>
        </div>
      </section>
    </div>
