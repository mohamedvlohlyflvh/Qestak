    ...
    <div className="min-h-screen px-4" dir="rtl">
      ...
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="glass-card p-6 space-y-4">
          ...
          {error && (
            <div className="bg-destructive/10 text-destructive text-sm rounded-lg p-3 text-center border border-destructive/20">
              {error}
            </div>
          )}
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 w-full py-2.5 border border-border rounded-lg text-sm text-foreground hover:bg-muted transition-colors"
          >
